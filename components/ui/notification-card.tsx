...
import { Check, ExternalLink, Clock, AlertCircle, Loader2 } from 'lucide-react';
...
const getActionIcon = (actionType: ActionType) => {
  ...
  switch (actionType) {
    case 'redirect': return <ExternalLink {...props} />;
    case 'api_call': return <Check {...props} />;
    case 'workflow': return <Clock {...props} />;
    case 'modal': return <AlertCircle {...props} />;
    default: return null;
  }
};
